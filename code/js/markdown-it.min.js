...
!function(e, r) {
    ...
    function a(e, r) {
        var t;
        return "string" != typeof r && (r = a.defaultChars),
        t = function(e) {
            var r, t, n = i[e];
            if (n)
                return n;
    ...
    l.prototype.parse = function(e, r) {
        ...
        !b[l] && (i || l && !v[l])) {
            ...
            for (-1 !== (f = -1 === d ? a.lastIndexOf("@") : a.lastIndexOf("@", d)) && (p = a.slice(0, f),
            a = a.slice(f + 1),
            this.auth = p),
            d = -1,
            t = 0; t < m.length; t++)
        ...
        var L = a.indexOf("#");
        -1 !== L && (this.hash = a.substr(L),
        a = a.slice(0, L));
        var z = a.indexOf("?");
        return -1 !== z && (this.search = a.substr(z),
        a = a.slice(0, z)),
        a && (this.pathname = a),
    ...
    var C = {
      ...
      , S = function(e, r, t) {
        ...
        return o === r || 0 !== s || (i.str = E(e.slice(o, r)),
        i.lines = 0,
        i.pos = r,
        i.ok = !0),
        i
    ...
    M.fence = function(e, r, t, n, s) {
        ...
        f = a.slice(2).join("")),
        0 === (o = t.highlight && t.highlight(u.content, h, f) || I(u.content)).indexOf("<pre") ? o + "\n" : p ? (i = u.attrIndex("class"),
    ...
    R.prototype.renderToken = function(e, r, t) {
        ...
        i.block && (o = !0,
        1 === i.nesting && r + 1 < e.length && ("inline" === (n = e[r + 1]).type || n.hidden || -1 === n.nesting && n.tag === i.tag) && (o = !1)),
        s += o ? ">\n" : ">")
    }
    ,
    ...
    function Y(e) {
        var r, t, n = 0;
        for (r = e.length - 1; r >= 0; r--)
            "text" !== (t = e[r]).type || n || Z.test(t.content) && (t.content = t.content.replace(/\+-/g, "\xb1").replace(/\.{2,}/g, "\u2026").replace(/([?!])\u2026/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/gm, "$1\u2014").replace(/(^|\s)--(?=\s|$)/gm, "$1\u2013").replace(/(^|[^-\s])--(?=[^-\s]|$)/gm, "$1\u2013")),
            "link_open" === t.type && "auto" === t.info && n--,
            "link_close" === t.type && "auto" === t.info && n++
    }
      ...
      , ce = [["normalize", function(e) {
                ...
                if ("inline" === b[t].type && e.md.linkify.pretest(b[t].content))
                    ...
                    r = (s = b[t].children).length - 1; r >= 0; r--)
                        if ("link_close" !== (i = s[r]).type) {
                            if ("html_inline" === i.type && (k = i.content,
                            /^<a[>\s]/i.test(k) && f > 0 && f--,
                            V(i.content) && f++),
                            !(f > 0) && "text" === i.type && e.md.linkify.test(i.content)) {
                                ...
                                h = i.level,
                                p = 0,
                                _.length > 0 && 0 === _[0].index && r > 0 && "text_special" === s[r - 1].type && (_ = _.slice(1)),
                                c = 0; c < _.length; c++)
                                    d = _[c].url,
                                    m = e.md.normalizeLink(d),
                                    e.md.validateLink(m) && (g = _[c].text,
                                    g = _[c].schema ? "mailto:" !== _[c].schema || /^mailto:/i.test(g) ? e.md.normalizeLinkText(g) : e.md.normalizeLinkText("mailto:" + g).replace(/^mailto:/, "") : e.md.normalizeLinkText("http://" + g).replace(/^http:\/\//, ""),
                            ...
                            for (r--; s[r].level !== i.level && "link_open" !== s[r].type; )
                                r--
    }
        ...
        if (e.md.options.typographer)
            for (r = e.tokens.length - 1; r >= 0; r--)
                "inline" === e.tokens[r].type && ($.test(e.tokens[r].content) && W(e.tokens[r].children),
        ...
        if (e.md.options.typographer)
            for (r = e.tokens.length - 1; r >= 0; r--)
                "inline" === e.tokens[r].type && ee.test(e.tokens[r].content) && ne(e.tokens[r].children, e)
    }
        ...
        t = a.length; r < t; r++)
            if ("inline" === a[r].type) {
                ...
                for (s = i = 0; s < o; s++)
                    "text" === n[s].type && s + 1 < o && "text" === n[s + 1].type ? n[s + 1].content = n[s].content + n[s + 1].content : (s !== i && (n[i] = n[s]),
                    i++);
                s !== i && (n.length = i)
            }
    }
    ...
    var Se = qe
      , Fe = [["table", function(e, r, t, n) {
        ...
        if (i >= e.eMarks[l])
            return !1;
        if (124 !== (C = e.src.charCodeAt(i++)) && 45 !== C && 58 !== C && !pe(C))
            return !1;
        if (45 === v && pe(C))
            return !1;
        for (; i < e.eMarks[l]; ) {
            if (124 !== (s = e.src.charCodeAt(i)) && 45 !== s && 58 !== s && !pe(s))
                return !1;
            i++
        }
    ...
    , ["paragraph", "reference", "blockquote", "list"]], ["list", function(e, r, t, n) {
        ...
        if (e.listIndent >= 0 && e.sCount[r] - e.listIndent >= 4 && e.sCount[r] < e.blkIndent)
            return !1;
        if (n && "paragraph" === e.parentType && e.sCount[r] >= e.blkIndent && (z = !0),
        (w = ke(e, r)) >= 0) {
            if (u = !0,
        ...
        1 !== g && (L.attrs = [["start", g]])) : L = e.push("bullet_list_open", "ul", 1),
        L.map = f = [r, 0],
    ...
    , ["paragraph", "reference", "blockquote"]], ["reference", function(e, r, t, n) {
        ...
        if (h < 0 || 58 !== g.charCodeAt(h + 1))
            return !1;
        for (C = h + 2; C < y; C++)
            if (10 === (s = g.charCodeAt(C)))
                v++;
            else if (!ve(s))
                break;
        ...
        if (C < y && 10 !== g.charCodeAt(C) && b)
            ...
            ve(s)); )
                C++;
        return !(C < y && 10 !== g.charCodeAt(C)) && (!!(p = be(g.slice(1, h))) && (n || (void 0 === e.env.references && (e.env.references = {}),
    ...
    , ["paragraph", "reference", "blockquote"]], ["heading", function(e, r, t, n) {
        ...
        if (e.sCount[r] - e.blkIndent >= 4)
            return !1;
        if (35 !== (s = e.src.charCodeAt(c)) || c >= l)
            return !1;
        for (o = 1,
        s = e.src.charCodeAt(++c); 35 === s && c < l && o <= 6; )
            o++,
    ...
    var ir = or
      , ar = [["text", function(e, r) {
        ...
        var t, n, s, o, i, a, c;
        return !!e.md.options.linkify && (!(e.linkLevel > 0) && (!((t = e.pos) + 3 > e.posMax) && (58 === e.src.charCodeAt(t) && (47 === e.src.charCodeAt(t + 1) && (47 === e.src.charCodeAt(t + 2) && (!!(n = e.pending.match(Ie)) && (s = n[1],
        ...
        if ((a = o + 1) < f && 40 === e.src.charCodeAt(a)) {
            ...
            (a >= f || 41 !== e.src.charCodeAt(a)) && (m = !0),
            a++
        }
        if (m) {
            if (void 0 === e.env.references)
                return !1;
            if (a < f && 91 === e.src.charCodeAt(a) ? (d = a + 1,
        ...
        if ((c = i + 1) < _ && 40 === e.src.charCodeAt(c)) {
            ...
            if (void 0 === e.env.references)
                return !1;
            if (c < _ && 91 === e.src.charCodeAt(c) ? (d = c + 1,
        ...
        !(60 !== e.src.charCodeAt(a) || a + 2 >= s) && (!(33 !== (t = e.src.charCodeAt(a + 1)) && 63 !== t && 47 !== t && !function(e) {
            var r = 32 | e;
            return r >= 97 && r <= 122
        ...
        if (35 === e.src.charCodeAt(i + 1)) {
            if (s = e.src.slice(i).match(Xe))
                return t || (n = "x" === s[1][0].toLowerCase() ? parseInt(s[1].slice(1), 16) : parseInt(s[1], 10),
